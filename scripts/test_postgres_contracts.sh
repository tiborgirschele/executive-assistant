...
TEST_FILES="${EA_TEST_FILES:-tests/test_artifacts_postgres_integration.py tests/test_channel_runtime_postgres_integration.py tests/test_generic_async_dependency_projection_contracts.py tests/test_memory_router_contracts.py tests/test_openapi_async_acceptance_examples_contracts.py tests/test_openapi_dependency_examples_contracts.py tests/test_plan_execute_input_contracts.py tests/test_plan_graph_validation_contracts.py tests/test_plan_scope_contracts.py tests/test_postgres_contract_matrix_integration.py tests/test_principal_fallback_contracts.py tests/test_rewrite_scope_contracts.py tests/test_rewrite_api_scope_contracts.py tests/test_rewrite_dependency_projection_contracts.py tests/test_step_io_contracts.py tests/test_step_parent_projection_contracts.py tests/test_tool_execution.py}"
