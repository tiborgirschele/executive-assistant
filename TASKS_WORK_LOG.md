...
| Q-126 | P0 | Continue Milestone 5 memory layer (`commitments` seed table + API stubs + principal scoping) | codex | queued | Chain after entities/relationships slice commit |
