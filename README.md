...
- compiled plan steps now also project explicit `owner`, `authority_class`, `review_class`, and `failure_strategy` semantics so executive workflows expose who owns each step and what runtime posture it expects before the DAG grows deeper
